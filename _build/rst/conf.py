...
project = "Machine Learing Compiler"
copyright = ""
author = "Tianqi Chen, Siyuan Feng, Ruihang Lai, Hongyi Jin"
release = "0.0.1"
...
html_theme_options = {
    ...
    'header_links': [
        ('Course', 'https://mlc.ai/summer22', True, 'fas fa-user-graduate'),('GitHub', 'https://github.com/mlc-ai/mlc-en', True, 'fab fa-github'),('中文版', 'https://mlc.ai/zh', True, 'fas fa-external-link-alt'),
    ],
    'show_footer': False
}
html_static_path = ['_static']

html_favicon = '_static/mlc-favicon.ico'

html_logo = '_static/mlc-logo-with-text-landscape.svg'

latex_documents = [
    (master_doc, "mlc.tex", "Machine Learing Compiler",
     author, 'manual'),
]
